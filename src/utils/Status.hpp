...
struct Status {
	...
	static inline const char pages[40][256] = {
		"\xC8" HTTP_PAGE("400", "Bad Request"),
		"\xCA" HTTP_PAGE("401", "Unauthorized"),
		"\xD2" HTTP_PAGE("402", "Payment Required"),
		"\xC4" HTTP_PAGE("403", "Forbidden"),
		"\xC4" HTTP_PAGE("404", "Not Found"),
		"\xD6" HTTP_PAGE("405", "Method Not Allowed"),
		"\xCE" HTTP_PAGE("406", "Not Acceptable"),
		"\xEC" HTTP_PAGE("407", "Proxy Authentication Required"),
		"\xD0" HTTP_PAGE("408", "Request Timeout"),
		"\xC2" HTTP_PAGE("409", "Conflict"),
		"\xBA" HTTP_PAGE("410", "Gone"),
		"\xD0" HTTP_PAGE("411", "Length Required"),
		"\xD8" HTTP_PAGE("412", "Precondition Failed"),
		"\xD4" HTTP_PAGE("413", "Content Too Large"),
		"\xCA" HTTP_PAGE("414", "URI Too Long"),
		"\xDE" HTTP_PAGE("415", "Unsupported Media Type"),
		"\xDC" HTTP_PAGE("416", "Range Not Satisfiable"),
		"\xD6" HTTP_PAGE("417", "Expectation Failed"),
		"\xC2" HTTP_PAGE("418", "(Unused)"),
		"\xD8" HTTP_PAGE("421", "Misdirected Request"),
		"\xDC" HTTP_PAGE("422", "Unprocessable Content"),
		"\xBE" HTTP_PAGE("423", "Locked"),
		"\xD4" HTTP_PAGE("424", "Failed Dependency"),
		"\xC4" HTTP_PAGE("425", "Too Early"),
		"\xD2" HTTP_PAGE("426", "Upgrade Required"),
		"\xDC" HTTP_PAGE("428", "Precondition Required"),
		"\xD4" HTTP_PAGE("429", "Too Many Requests"),
		"\xF0" HTTP_PAGE("431", "Request Header Fields Too Large"),
		"\xEC" HTTP_PAGE("451", "Unavailable For Legal Reasons"),
		"\xDC" HTTP_PAGE("500", "Internal Server Error"),
		"\xD0" HTTP_PAGE("501", "Not Implemented"),
		"\xC8" HTTP_PAGE("502", "Bad Gateway"),
		"\xD8" HTTP_PAGE("503", "Service Unavailable"),
		"\xD0" HTTP_PAGE("504", "Gateway Timeout"),
		"\xE6" HTTP_PAGE("505", "HTTP Version Not Supported"),
		"\xE0" HTTP_PAGE("506", "Variant Also Negotiates"),
		"\xDA" HTTP_PAGE("507", "Insufficient Storage"),
		"\xCC" HTTP_PAGE("508", "Loop Detected"),
		"\xCA" HTTP_PAGE("510", "Not Extended"),
